        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="card text-white bg-danger o-hidden h-8">
                    <a class="card-footer text-white clearfix small z-1" href="/vehicle_load_all">
                        <span class="float-left">SAMOCHODY</span>
                        <span class="float-right">
            <i class="fas fa-angle-right"></i>
            </span>
                    </a>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="card text-white bg-dark o-hidden h-8">
                    <a class="card-footer text-white clearfix small z-1" href="/raport_1_form">
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="card text-white bg-info o-hidden h-8">
                    <a class="card-footer text-white clearfix small z-1" href="/status_load_all">
                        <span class="float-left">STATUSY</span>
